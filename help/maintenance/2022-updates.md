---
title: Workfront 维护更新 2022年
description: 2022年维护更新 [!DNL Adobe Workfront]
...
为了提高更新区域性能，我们对您可以在更新或现有更新的回复中可以输入的字符数进行了新限制。 新限制为 15,000 个字符。 此更新未更改使用 API 时允许的字符数。 更新的 API 字符限制为 4,000。 更新支持“工作负载均衡器”过滤器中的“预输入”类型自定义字段。
