...
**[!UICONTROL 故事点] 任务和问题列表及报告中添加的字段**

_报告_

的 [!UICONTROL 故事点] 字段现在可添加到列表和任务或问题报告中。 它是一个可编辑的自由表单字段，它未绑定到计划小时数或团队分配。
...
的 [!UICONTROL 展示板] 图标 [!UICONTROL 主菜单] 对于没有布局模板的用户。 对于创建的任何新布局模板，展示板也默认包含在主菜单中。现有的布局模板未更改。
