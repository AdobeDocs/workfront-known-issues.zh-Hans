...
当用户使用显示逻辑在自定义表单中输入信息时，不会出现根据显示逻辑应显示的字段。

#### 主页

**参与者显示的“处理此项工作”按钮不起作用**

参与者用户有权访问主页中“我的工作”小组件中无法正常运行的“处理它”按钮。

#### 报告

**自定义季度未出现在报告提示中**

当用户运行具有基于日期的提示的报表时，自定义季度未出现在提示的选择列表中。
...
在包含“类别名称”字段的报表中查看列表时，无法单击“类别名称”列的内容以打开相应的自定义表单。

**对报告中的自定义颜色进行分组不起作用**

在Report Builder中为组分配自定义颜色时，运行报表时不会显示颜色选择。

报告&#x200B;**长加载时间**

报告需要较长的时间来加载。这会影响查看报告以及在 Report Builder 中编辑和创建报告。

报告提示中计算的“日期/时间”字段缺少&#x200B;**时间字段**

当运行具有用作提示的自定义日期/时间字段的报表时，提示界面中缺少时间选择字段。

**无法查看共享的报告/仪表板**

当用户尝试访问已与他们共享的报表或仪表板时，该报表或仪表板无法访问。
