...
**在离开更新目标和评论 Beta 版体验中出现的问题时，将图像保留为草稿**
...
现在，如果您在撰写附加了图像的消息期间离开更新页面，该消息和图像会在您返回时保留。在本次更新之前，未提交的评论会被保留，但图片会被删除。目前这在目标的更新部分中，以及在启用评论 Beta 版体验时出现的问题的“更新”部分中可用。
...
现在，当有人添加评论或回复，或从“更新”区域删除评论时，您可以实时看到新评论或有关评论已被删除的指示，而不会存在延迟。目前这在目标的更新部分中，以及在启用评论 Beta 版体验时出现的问题的“更新”部分中可用。
...
**在问题的[!UICONTROL 更新]部分（新的评论 Beta 版体验）和[!UICONTROL 目标]**&#x200B;中，在屏幕可见区域之外显示新评论

_更新_

我们为[!UICONTROL 更新]部分添加了通知横幅，以便在对可能位于屏幕上可见区域之外的项目有较新的评论时通知用户。目前在目标的[!UICONTROL 更新]部分中，以及在为问题启用新的评论 Beta 版体验时问题的“更新”部分中，提供此更新。
