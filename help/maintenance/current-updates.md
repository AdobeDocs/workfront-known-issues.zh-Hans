...
**来自校样的提及次数未出现在“提及次数”小组件中**

当验证评论中提及用户时，该提及不包括在“主页”的提及构件中。

#### 登录

**Workfront登录后未加载**

当用户登录到Workfront时，Workfront不加载。 如果用户刷新页面，则Workfront会按预期加载。

#### 报告

Workfront规划字段未显示在画布功能板Report Builder中
