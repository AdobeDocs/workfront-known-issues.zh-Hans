...
如果“我的工作”构件在新主页的顶部，则它可获得所有预期的对象。但是，如果此构件在该页面上的任何其他构件下，则它只能获得 10 个对象。
