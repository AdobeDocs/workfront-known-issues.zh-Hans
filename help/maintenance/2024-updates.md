...
按列对仪表板中的报告进行排序时，该列会消失，且内容不会排序。

#### 报告

**图表选项下的组列导致错误**

在带有图表的报告中启用“对图表下的列进行分组”选项时，显示以下错误消息：“发生了错误，我们正在努力解决该问题。 要继续工作，请尝试刷新此浏览器页面。”
...
当用户在更新中被标记时，他们无法看到是谁标记了他们。 当设置“其他公司的人员应仅从……查看用户”时，会发生这种情况 设置为“他们的公司”。
