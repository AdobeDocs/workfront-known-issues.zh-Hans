...
| **问题** | **上次修改** |
| ----------------------------------------------------------------- | ----------------- |
| [安装程序：无法以其他用户身份登录](known-issues-workfront/wf-setup-cannot-login-as-in-preview.md) | 2025年7月7日 |
| [集成：用于Slack集成的Workfront存在问题](known-issues-workfront/wf-integrations-slack-integration-not-working.md) | 2025年7月7日 |
