...
+ [!DNL Adobe Workfront] {#new-workfront-experience}
   ...
   + [!DNL Adobe Workfront] {#wf-current} 的当前问题
      + [文档：文档审批未出现在 [!UICONTROL 审批] 区域](known-issues-workfront/wf-documents-approvals-not-on-tab.md)
      ...
      + [验证：在[!UICONTROL 验证查看器]中无法在验证之间切换](known-issues-workfront/wf-proofs-cannot-switch-between-proofs.md)
      ...
      + [验证：对验证发表评论时无法使用折线工具](known-issues-workfront/wf-proof-polyline-tool-does-not-work.md)
      ...
      + [验证：将用户添加到验证时，无法打开下拉列表](known-issues-workfront/wf-proofs-dropdowns-disabled-when-adding-user.md)
...
+ [!DNL Workfront Proof] {#proof}
   ...
   + [!DNL Workfront Proof] {#proof-current} 的当前问题
      ...
      + [验证：文本选项框显示“textAnnotations”](known-issues-workfront-proof/proof-text-shows-textannotation.md)
