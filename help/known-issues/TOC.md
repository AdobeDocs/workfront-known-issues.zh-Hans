...
+ [!DNL Adobe Workfront] {#new-workfront-experience}
   ...
   + [!DNL Adobe Workfront] {#wf-current} 的当前问题
      ...
      + [展示板：状态更改时信息卡未移动到适当的列](known-issues-workfront/wf-boards-card-not-moving-when-status-changed.md)
      ...
      + [验证：激活阶段时出现问题](known-issues-workfront/wf-proofs-stage-activation-issues.md)
      ...
      + [验证：无法创建验证的新版本](known-issues-workfront/wf-proofs-cannot-create-new-version.md)
      ...
      + [验证：对验证作出评论时显示额外的空白评论](known-issues-workfront/wf-proofs-extra-blank-comment.md)
      + [展示板：显示“无标题”卡片并且其出现在积压事项中](known-issues-workfront/wf-boards-untitled-cards-displaying-and-saved.md)
      + [验证：生成验证耗时很长](known-issues-workfront/wf-proofs-proof-takes-days-to-generate.md)
      + [文档：无法将文档移至其他文件夹](known-issues-workfront/wf-documents-cannot-move-to-folder.md)
      + [验证：验证似乎褪色或被裁切](known-issues-workfront/wf-proofs-desaturated-and-cropped.md)
      ...
      + [验证：无法生成验证](known-issues-workfront/wf-proofs-fail-to-generate.md)
      ...
      + [验证：在预览环境中创建验证缓慢](known-issues-workfront/wf-proofs-in-preview-created-slowly.md)
...
+ [!DNL Workfront Proof] {#proof}
   ...
   + [!DNL Workfront Proof] {#proof-current} 的当前问题
      ...
      + [[!UICONTROL Workfront 验证]：电子邮件和通知发生延迟](known-issues-workfront-proof/proof-delayed-notification.md)
