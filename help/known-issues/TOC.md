...
+ [!DNL Adobe Workfront] {#new-workfront-experience}
   ...
   + [!DNL Adobe Workfront] {#wf-current} 的当前问题
      ...
      + [[!UICONTROL 工作负载平衡器]：[!UICONTROL 工作负载平衡器]加载缓慢](known-issues-workfront/wf-workload-balancer-loads-slowly.md)
      ...
      + [工作负载平衡器：同时使用多个过滤器时结果不准确](known-issues-workfront/wf-workload-balancer-multiple-filters.md)
