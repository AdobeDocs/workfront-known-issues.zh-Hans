...
+ [!DNL Adobe Workfront] {#new-workfront-experience}
   ...
   + [!DNL Adobe Workfront] {#wf-current} 的当前问题
      ...
      + [自定义表单：计算字段中的 [!UICONTROL HOUR] 函数使用 UTC](known-issues-workfront/wf-custom-form-hours-use-utc.md)
...
+ [!DNL Workfront Proof] {#proof}
   ...
   + [!DNL Workfront Proof] {#proof-current} 的当前问题
      ...
      + [验证：不与验证工作流中的用户共享验证](known-issues-workfront-proof/proof-user-in-stage-does-not-get-access.md)
...
+ [!DNL Adobe Workfront Fusion] {#fusion}
   ...
   + [!DNL Workfront Fusion] {#fusion-current} 的当前问题
      ...
      + [[!DNL Workfront Fusion]：[!UICONTROL 未能加载数据]错误](known-issues-workfront-fusion/fusion-failed-to-load-data-error.md)
