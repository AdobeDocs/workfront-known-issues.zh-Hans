...
+ [!DNL Adobe Workfront] {#new-workfront-experience}
   ...
   + [!DNL Adobe Workfront] 中的当前问题 {#wf-current}
      + [主页：验证中的提及次数不会出现在提及次数小部件中](known-issues-workfront/wf-home-mentions-from-proofs-not-in-widget.md)
      + [集成：未触发来自Workfront的Slack通知](known-issues-workfront/wf-integrations-slack-notifications-not-triggering.md)
      + [审批：无法从主页中的我的审批小组件审批文档](known-issues-workfront/wf-approval-not-work-from-widget.md)
      + [Workfront计划：“无法提交请求”错误](/help/known-issues/known-issues-workfront/wf-planning-error-fail-to-submit-request.md)
      + [审批：审批自动锁定](known-issues-workfront/wf-approvals-are-locked.md)
      + [分配：无法从报表中保存高级分配更改](known-issues-workfront/wf-assignments-cannot-save-advanced-from-report.md)
      + [报告：Workfront Planning字段未出现在画布功能板Report Builder中](known-issues-workfront/wf-reporting-canvas-dashboards-no-planning.md)
      + [用户：无法删除直接报表](known-issues-workfront/wf-users-cannot-remove-direct-reports.md)
      + [请求：填写请求时无法上传文档](known-issues-workfront/wf-request-cannot-submit-with-document.md)
